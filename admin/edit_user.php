...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color : #5F9EA0;">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <?php 
                $id_u=$_GET['id_user'];
                $result=mysqli_query($mysqli, "SELECT *FROM log_in WHERE id_user=$id_u");

                while($row=mysqli_fetch_array($result)){
            ?>
            <!-- isi disini -->
            <form action="" method="POST" class="container" autocomplete="off" required="true">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input class="form-control" type="text" name="username" value="<?php echo $row['username'];?>" required="true">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nama_pf" class="col-sm-4 col-form-label">Nama Lengkap</label>
                    <div class="col-md-6">
                        <input class="form-control" type="text" name="nama_pf" value="<?php echo $row['nama'];?>" required="true">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="password" class="col-sm-4 col-form-label">Password</label>
                    <div class="col-md-6">
                        <input class="form-control" type="text" name="password" placeholder="Masukkan password kembali" required="true">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="re_password" class="col-sm-4 col-form-label">Re-Password</label>
                    <div class="col-md-6">
                        <input class="form-control" type="password" name="re_password" value="" required="true">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="email" class="col-sm-4 col-form-label">email</label>
                    <div class="col-md-6">
                        <input class="form-control" type="email" name="email" value="<?php echo $row['email'];?>" required="true">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="text-center">
                    ...
                    <input type="submit" name="set" class="btn btn-outline-primary" value="SIMPAN">
                </div>
                <?php }?>
            </form>
            <!-- action -->
                <?php
                    if(isset($_POST['set'])){
                        ...
                        if($password != $repassword){
                            ...
                            $edit_u=mysqli_query($mysqli, "UPDATE log_in SET username='$username',nama='$nama_pf',pass='$password',email='$email',nomor_hp='$no_telp' 
                            WHERE id_user='$id_u'");
                            if($edit_u){
                                // echo " Disimpan";
                                echo "<script>

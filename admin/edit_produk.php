    ...
    <div class="container-fluid">
        ...
        <!-- <h2>HALAMAN ADMIN</h2> -->
            ...
            <?php 
                ...
                $re_edit=mysqli_query($mysqli, "SELECT *FROM tb_cpp WHERE id_cpp=$id_barang");

                while($rows=mysqli_fetch_array($re_edit)){
            ?>
        <div class="card shadow mb-4">
            ...
            <form action ="" method= "POST" autocomplete="off">
                <div>
                    <div>
                        <input type="hidden" name="id_cpp" class="form-control" value="<?php echo $rows['id_cpp'];?>">
                    </div>
                    ...
                    <div class="form-group col-md">
                        <select type="text" name="id_user" class="form-control"required="true">
                            <option value="-"<?php if($rows['id_user'] == '-')echo "selected";?>>-</option>
                        <?php 
                            $pil=mysqli_query($mysqli, "SELECT *FROM log_in WHERE id_user");
                            while($pil_id=mysqli_fetch_array($pil)){
                        ?>
                            <option value="<?php echo $pil_id['id_user'];?>" <?php if($rows['id_user'] == $pil_id['id_user'])echo "selected";?>><?php echo $pil_id['nama'];?></option>
                ...
                <div>
                    ...
                    <div class="form-group col-md">
                        <input type="text" name="nama_ush" class="form-control" value="<?php echo $rows['nama_ush'];?>" required="true">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select type="text" name="sub_ctry" class="form-control"required="true">
                            <option value="-"<?php if($rows['sub_ctg'] == '-')echo "selected";?>>-</option>
                        <?php 
                            $pil_ctg=mysqli_query($mysqli, "SELECT *FROM kategori_produk WHERE id_ctg");
                            while($il_ctg=mysqli_fetch_array($pil_ctg)){
                        ?>
                            <option value="<?php echo $il_ctg['kategori'];?>" <?php if($rows['sub_ctg'] == $il_ctg['kategori'])echo "selected";?>><?php echo $il_ctg['nama_kategori'];?></option>
                ...
                <div>
                    ...
                    <div class="form-group col-md">
                        <input type="text" name="ktg_lain" class="form-control" placeholder="Keterangan tambahan" value="<?php echo $rows['ktg_lain'];?>" required="true">
                    </div>
                </div>
                <div class="row col-md text-center">
                    ...
                    <label class="control-label" for="dekade" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Waktu Produksi</label>
                        <div>
                            <select type="text" name="dekade" class="form-control" placeholder="Masukkan total biaya bahan baku" required="true">
                                <option value="-">-</option>
                                <option value="Harian" <?php if($rows['dekade'] == 'Harian')echo "selected";?>>Harian</option>
                                <option value="Mingguan" <?php if($rows['dekade'] == 'Mingguan')echo "selected";?>>Mingguan</option>
                                <option value="Bulanan" <?php if($rows['dekade'] == 'Bulanan')echo "selected";?>>Bulanan</option>
                                <option value="Tahunan" <?php if($rows['dekade'] == 'Tahunan')echo "selected";?>>Tahunan</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                    <label class="control-label col-md-6" for="bhbk" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Biaya Bahan Baku</label>
                        <input type="number" name="bhbk" class="form-control" placeholder="Masukkan total biaya bahan baku" value="<?php echo $rows['bhbk'];?>" required="true">
                    </div>
                    <div class="form-group col-md-6">
                    <label class="control-label col-md-9" for="tngkj" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Biaya tenaga kerja</label>
                        <input type="number" name="tngkj" class="form-control" placeholder="Masukkan total biaya tenaga kerja" value="<?php echo $rows['tngkj'];?>" required="true">
                    </div>
                    <div class="form-group col-md-6">
                    <label class="control-label col-md-6" for="ovrhd" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Biaya overhead</label>
                        <input type="number" name="ovrhd" class="form-control" placeholder="Masukkan total biaya overhead" value="<?php echo $rows['ovrhd'];?>" required="true">
                    </div>
                    <div class="form-group col-md-6">
                    <label class="control-label col-md-6" for="by_lain" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Biaya lainnya</label>
                        <input type="number" name="by_lain" class="form-control" placeholder="Masukkan total biaya lainnya" value="<?php echo $rows['by_lain'];?>" required="true">
                    </div>
                    <div class="form-group col-md-6">
                    <label class="control-label col-md-6" for="jm_produk" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Jumlah Produksi</label>
                        <input type="number" name="jm_produk" class="form-control" placeholder="Masukkan banyaknya produksi" value="<?php echo $rows['jm_produk'];?>" required="true">
                    </div>
                    <div class="form-group col-md-6">
                    <label class="control-label col-md-8" for="jm_jual" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Jumlah Permintaan</label>
                        <input type="number" name="jm_jual" class="form-control" placeholder="Masukkan banyaknya permintaan" value="<?php echo $rows['jm_jual'];?>" required="true">
                    </div>
                    <div class="form-group col-md-6">
                    <label class="control-label col-md-6" for="margin_cpp" style="color:black; font-family:Cambria; font-size:18px;margin-top:20px; margin-bottom:-10px;">Margin</label>
                        <input type="number" name="margin_cpp" min="0" max="100" class="form-control" placeholder="0.00 %" step="0.01" value="<?php echo $rows['margin_cpp'];?>" required="true">
                    </div>
                ...
                <center>
                    <a href='list_produk.php' class='btn btn-warning'>Kembali</a>

                    <input type="submit" class='btn btn-outline-primary' name="edit" value="UBAH&SIMPAN">
                    </center><br>
                </div>
                <?php 
                    }
                ...
                <?php
                    ...
                    $edit_produk=mysqli_query($mysqli, "UPDATE tb_cpp SET id_user='$kd_user', nama_ush='$nama_ush', sub_ctg='$sub_ctry', 
